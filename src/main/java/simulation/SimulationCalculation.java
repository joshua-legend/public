...
public class SimulationCalculation {
    ...
    static HashMap <String, HashMap> totalHashmap;
    public SimulationCalculation() throws SQLException {
    ...
    public void test(int google,int view,int sub,int ratio) throws SQLException {
        ...
        totalHashmap = new SQL_Area(percent_foreach_Hashmap).getHashMap();
